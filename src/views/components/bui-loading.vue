...
<script>
    ...
    export default {
        ...
        data: () => ({
            showLoading: false,
            tid: 0,
            GIF: 'https://img.alicdn.com/tfs/TB1aks3PpXXXXcXXFXXXXXXXXXX-150-150.gif',
            BLACK_GIF: 'https://img.alicdn.com/tfs/TB1Ep_9NVXXXXb8XVXXXXXXXXXX-74-74.gif',
            PART: 'https://gtms02.alicdn.com/tfs/TB1y4QbSXXXXXbgapXXXXXXXXXX-50-50.gif',
        }),
        watch: {
            show () {
                this.setShow();
